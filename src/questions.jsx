import cinSeddini from "./pictures/cin-seddi.jpg";
...
const questions = [
  ...
  {
    question:
      "3 - Tarkan'ın 'Hüp' klibini izledikten sonra gaza gelip 'Tarkan keşke beni hüpletseydi' diye açıklamada bulunan kişi kimdir?",
